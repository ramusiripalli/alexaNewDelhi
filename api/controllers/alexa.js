...
response.titleText = "Update For New Delhi Weather";


  weather1.find({search: 'New Delhi, Delhi', degreeType: 'C'}, function(err, result) {
    if(err) {
    ...
    response.redirectionUrl = "http://ramusiripalli.xyz";
    response.mainText = "Hello from weather. Todays weather in NewDelhi is expected to be " + day0weather + " Degree Celsius "+ day0weather1 +". Tomorrows weather in NewDelhi is Expected to be " + day1weather + " Degree Celsius "+ day1weather1 + ". Third day weather in New Delhi is expected to  be " + day2weather + " Degree Celsius "+ day2weather2 +" . Fourth day weather will be " + day3weather + " Degree Celsius "+ day3weather3 + ". Fifth day weather will be " + day4weather+ " Degree Celsius "+ day4weather4;
    res.json(response);
    }
